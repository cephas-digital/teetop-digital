export const TOKEN = "TEETOP_HONOURWORLD_WEBSITE";
export const TOKEN_TEMP = "TEETOP_HONOURWORLD_TEMP_WEBSITE";
export const TOKEN_TEMP_AUTH = "TEETOP_HONOURWORLD_TEMP_AUTH_WEBSITE";
