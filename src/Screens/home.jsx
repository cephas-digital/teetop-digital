	...
	return (
		<div className="py-5">
			<section className="py-5">
				...
				<div className="d-flex justify-content-center">
					<p className="text-center w-50 w50 fontReduce">
						With Teetop digital, You will enjoy a fast data delivery with
...
export const StandToGain = () => {
	let type = [
		...
		// },
		{
			...
			description: `Periodically, Teetop digital offers the best discounts and special deals on all of our services, including data, airtime, and cable subscriptions. Stay tuned for updates on our special offers and take advantage of the opportunity to save on these services.`,
		},
		// {
